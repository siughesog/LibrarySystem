			...
			?>
			  ...
			  <tbody> 
				...
				?>
						<tr> 
						<td>0</td> 
					  <td><input value="TaipeiMain"/></td> 
					  <td><input value="市立總圖書館"/></td> 
					  <td><input value="08:00 - 21:00"/></td> 
					  <td><input value="臺北市建國南路二段125號"/></td> 
					  <td><input value="臺北市立圖書館總館位於臺灣臺北市大安區，面對大安森林公園，近捷運大安森林公園站，樓板總面積約6,000餘坪，啟用至今，已累積50萬1500冊的藏書和視聽資料。"/></td> 
					  <th scope="row">
						  	<a class="btn btn-default" role="button" onclick="UpdateContent();">按我更新</a>
						  	<a class="btn btn-default" role="button" onclick="DeleteContent();">按我刪除</a>
						     </th> 
